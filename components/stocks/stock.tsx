...
export function Stock({ props: { symbol, price, delta } }: { props: Stock }) {
  ...
  return (
    <div className="rounded-xl border bg-primary-950 p-4 text-green-400">
      ...
      >
        {priceAtTime.x > 0 ? (
          <div
            className="pointer-events-none absolute z-10 flex w-fit select-none gap-2 rounded-md bg-primary-800 p-2"
            style={{
        ...
        {startHighlight ? (
          <div
            className="pointer-events-none absolute h-32 w-5 select-none rounded-md border border-zinc-500 bg-primary-500/20"
            style={{
              left: startHighlight,
              width: endHighlight
